...
\title{An introduction to QML}
\subtitle{Advantages of QML in Embedded Computing}
\subject{}
...
\frame{
  ...
  You can view at \href{https://github.com/Pritvi-DevConMU-MSCC/Introduction2QML/}
  {Introduction to QML}
...
\frame{
  \frametitle{framework of libraries built on the top of Qt}

\url{https://www.qt.io/}

\begin{block}{Qt has always been the most powerfull SDK to built Graphical
Software}

 Written in C++, it is

 \begin{itemize}
  \item Cross-platform, Embedded Devices, Smartphones, Automobile, IOT, TV
  \item Fast, highly modular design and Future proof
  \item licensed under the LGPL
  \item heavily used by some commercial Customers including LG, Mercedes-Benz,
  AMD, Denso, Panasonic, Sky
  \item used by commonly used applications and examples include VLC, Google
  Earth, Skype, Maya, Teamviwer, Telegram
 \end{itemize}
\end{block}
...
\frame{
 ...
 \begin{block}{QML, Qt Modeling Language }
 is a declarative user interface markup language for designing user
 interface–centric applications, the QML runtime implements the ECMAScript
